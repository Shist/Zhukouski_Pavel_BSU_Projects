...
{
	int Worker_code;
	char Worker_last_name[256];
	char Post[256];
	char Gender[256];
	int contract_signing_day;
	int contract_signing_month;
	int contract_signing_year;
...
{
	struct WORKER2* Workers_arr = (struct WORKER2*)malloc(N * sizeof(struct WORKER2));
