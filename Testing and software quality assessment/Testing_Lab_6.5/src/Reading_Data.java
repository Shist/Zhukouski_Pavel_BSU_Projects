...
{ // Чтение данных
    ...
    { // Читает одну строку
        ...
        if (str_arr.length != 2) // В нашей входной строке должно быть два числа
            return "Mistake! An invalid number of numbers was entered in the input string. There must be two.";
