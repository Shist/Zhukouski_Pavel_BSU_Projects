...
--
-- Host: localhost    Database: updated_library_db
-- ------------------------------------------------------
...
CREATE SCHEMA `updated_library_db` ;
...
INSERT INTO 'formular' VALUES (1,2,7,'2020-02-11','2020-08-11','2020-08-17'),(2,5,2,'2020-04-25','2020-10-25','2020-11-14'),(3,1,4,'2020-05-21','2020-11-21','2020-11-21'),(4,1,3,'2020-07-27','2020-01-27','2020-01-28'),(5,1,2,'2020-09-24','2021-03-24','2021-03-26'),(6,2,5,'2020-10-12','2021-04-12','2021-04-25'),(7,6,4,'2020-11-09','2021-05-09','2021-05-10'),(8,1,1,'2020-11-22','2021-05-22','2021-05-24'),(9,2,6,'2020-11-28','2021-05-28','2021-05-29');
...
INSERT INTO 'user' VALUES ('Anthony','1111111','R','Perez'),('Arturo','2222222','R','Hutla'),('Byron','3333333','R','Gibbs'),('Heather','4444444','R','Getshum'),('Marlon','5555555','R','Ehetna'),('Mary','6666666','R','Collier'),('Pavel','7777777','L','Zhukouskiy'),('Steve','8888888','R','Alvarez'),('Test','12345678','R','Test User'),('Willie','9999999','R','Hanson');
/*!40000 ALTER TABLE 'user' ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'updated_library_db'
--

--
-- Dumping routines for database 'updated_library_db'
--
...
-- Dump completed on 2021-05-24 21:42:57
