    ...
    MainFrame() {
        ...
        BtAppend.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                arr[12] = textField1.getText();
                for (int i = 5; i < 13; i++)
                    if (errNum == -1 && arr[i].isEmpty())
                        errNum = i;
                String [] arrRes = {"Номер дома", "Номер квартиры", "Адрес",
                        "ФИО владельца", "Дата платежа", "Сумма платежа", "Процент пени", "На сколько дней просрочен платёж"};
