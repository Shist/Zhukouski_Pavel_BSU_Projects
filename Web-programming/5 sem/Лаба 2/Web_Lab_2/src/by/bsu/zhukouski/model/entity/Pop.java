...
public class Pop extends AbstractComposition {
     ...
     * Hip-hop genre
     */
    private Pop.PopGenre genre;

    /**
     * Create new object
     * @see Pop#Pop(String, String, double, Pop.PopGenre)
     */
    public Pop() {
    }
     ...
     * @see Pop#Pop()
     */
    public Pop(String name, String authorName, double duration, Pop.PopGenre genre) throws InvalidDataException {
        setName(name);
     ...
     * @param genre - genre
     */
    public void setGenre(Pop.PopGenre genre) {
        this.genre = genre;
    }
