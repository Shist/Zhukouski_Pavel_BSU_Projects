...
// —читает относительную энтропию по двум файлам-распределени€м
...
main(int argc, char **argv)
{
    if (3 != argc)
    {
        std::cerr << "please provide two files with distributions";
        return 1;
    }
    ...
    for (const auto &f_kv : f_distrib)
        ...
        {
            std::cerr << "the g domain isn't a superset of the f domain";
            return 1;
        }
