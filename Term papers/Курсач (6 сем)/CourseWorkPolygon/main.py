        ...
        try:
            ...
            with sr.Microphone() as source2:
                ...
                if "stop" in MyText:
                    ...
                    command_lst = []
                    ref["square"]()
                elif "run" in command_lst and "line" in MyText:
                    command_lst = []
                    ref["line"]()
                elif "run" in command_lst and "rectangular" in MyText:
                    command_lst = []
                    ref["rectangular"]()
                elif "run" in command_lst and "dance" in MyText:
                    command_lst = []
                    ref["dance"]()
                elif "run" in command_lst and "move" in MyText:
                    command_lst = []
                    ref["move"]()
                elif "run" in command_lst and "slow" in MyText:
                    command_lst = []
                    ref["slow"]()
                elif "run" in command_lst and "fast" in MyText:
                    command_lst = []
                    ref["fast"]()
