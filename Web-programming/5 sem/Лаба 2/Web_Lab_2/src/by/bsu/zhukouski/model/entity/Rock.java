...
public class Rock extends AbstractComposition {
     ...
     * Hip-hop genre
     */
    private Rock.RockGenre genre;

    /**
     * Create new object
     * @see Rock#Rock(String, String, double, Rock.RockGenre)
     */
    public Rock() {
    }
     ...
     * @see Rock#Rock()
     */
    public Rock(String name, String authorName, double duration, Rock.RockGenre genre) throws InvalidDataException {
        setName(name);
     ...
     * @return genre
     */
    public Rock.RockGenre getGenre() {
        return genre;
    }
     ...
     * @param genre - genre
     */
    public void setGenre(Rock.RockGenre genre) {
        this.genre = genre;
    }
