...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.message_label)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.confirm_button.setText(_translate("Dialog", "Log In"))
        self.switch_button.setText(_translate("Dialog", "Register"))
        self.label_4.setText(_translate("Dialog", "Haven\'t got account?"))
